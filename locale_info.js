...
// List with only variants of the top 11 languages by # of speakers.
// https://en.wikipedia.org/wiki/List_of_languages_by_number_of_native_speakers
/*
var TEXT_POSSIBILITIES_DEFAULT = [
  "\u8D5E\u52A9\u5185\u5BB9", // (赞助内容) Chinese (Simplified)
  "\u8D0A\u52A9", // (贊助) Chinese (Traditional, Hong Kong/Taiwan)
  "Publicidad", // Spanish (Standard and Spain)
  "Patrocinado", // Spanish (Columbia)
  "Sponsored", // English (US/UK)
  "\u092A\u094D\u0930\u093E\u092F\u094B\u091C\u093F\u0924", // (प्रायोजित) Hindi
  "\u0625\u0639\u0644\u0627\u0646 \u0645\u064F\u0645\u0648\u0651\u064E\u0644", // (إعلان مُموَّل) Arabic
  "Patrocinado", // Portuguese (Brasil/Portugal)
  "\u09B8\u09CC\u099C\u09A8\u09CD\u09AF\u09C7", // (সৌজন্যে) Bengali
  "\u0420\u0435\u043A\u043B\u0430\u043C\u0430", // (Реклама) Russian
  "\u5E83\u544A", // (広告) Japanese (Standard and Kansai)
  "\u0A38\u0A30\u0A2A\u0A4D\u0A30\u0A38\u0A24\u0A40 \u0A2A\u0A4D\u0A30\u0A3E\u0A2A\u0A24", // (ਸਰਪ੍ਰਸਤੀ ਪ੍ਰਾਪਤ) Punjabi
  "Gesponsert" // German
];
var LOCALE_MAP = {
  "zh_CH": "\u8D5E\u52A9\u5185\u5BB9", // (赞助内容) Chinese (Simplified)
  "zh_TW": "\u8D0A\u52A9", // (贊助) Chinese (Taiwan)
  "zh_HK": "\u8D0A\u52A9", // (贊助) Chinese (Hong Kong)
  ...
  "hi_IN": "\u092A\u094D\u0930\u093E\u092F\u094B\u091C\u093F\u0924", // (प्रायोजित) Hindi
  "ar_AR": "\u0625\u0639\u0644\u0627\u0646 \u0645\u064F\u0645\u0648\u0651\u064E\u0644", // (إعلان مُموَّل) Arabic
  "pt_BR": "Patrocinado", // Portuguese (Brasil)
  "pt_PT": "Patrocinado", // Portuguese (Portugal)
  "bn_IN": "\u09B8\u09CC\u099C\u09A8\u09CD\u09AF\u09C7", // (সৌজন্যে) Bengali
  "ru_RU": "\u0420\u0435\u043A\u043B\u0430\u043C\u0430", // (Реклама) Russian
  "ja_JP": "\u5E83\u544A", // (広告) Japanese
  "ja_KS": "\u5E83\u544A", // (広告) Japanese (Kansai)
  "pa_IN": "\u0A38\u0A30\u0A2A\u0A4D\u0A30\u0A38\u0A24\u0A40 \u0A2A\u0A4D\u0A30\u0A3E\u0A2A\u0A24", // (ਸਰਪ੍ਰਸਤੀ ਪ੍ਰਾਪਤ) Punjabi
